...
| Backups | Central de proteção por instalação com conexão individual ao Google Drive, autorização OAuth protegida no servidor, cópia manual compactada para PC, histórico e rotina diária idempotente após a primeira conexão do mercado. |
